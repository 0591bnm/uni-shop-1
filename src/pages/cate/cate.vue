  ...
  <view class="scroll-view-container">
    ...
    <scroll-view class="left-scroll-view" scroll-y="true" :style="{height:wh+'px'}">
      <block v-for="(item,i) in cateList" :key ="i">
        <view :class="i==active?'left-scroll-view-item active':'left-scroll-view-item'" @click="activeChanged(i)">{{item.cat_name}}</view>
      </block>
    </scroll-view>
    <!-- 右侧的滑动区域 -->
    <scroll-view scroll-y="true" style="height: 300px;" :style="{height:wh+'px'}" :scroll-top="scrollTop">
